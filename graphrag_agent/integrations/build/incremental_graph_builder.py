...
from graphrag_agent.config.settings import (
    ...
    entity_definitions, relationship_definitions,
...
class IncrementalGraphUpdater:
    ...
    def __init__(self, files_dir: str, registry_path: str = None):
        ...
        # 初始化图写入器
        self.graph_writer = GraphWriter(self.graph, entity_types=entity_types, relationship_types=relationship_types,
                                        relationship_definitions=relationship_definitions, batch_size=BATCH_SIZE, max_workers=MAX_WORKERS)
