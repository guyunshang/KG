...
entity_definitions = {
    ...
    "故障表现": "设备发生的具体异常状态或现象，如拒动、误动、过热、断裂等。",
    "故障原因": "导致故障发生的直接或间接诱因。",
    "抢修团队": "负责处理故障的组织单元、班组或部门、队伍等。",
    "抢修人员": "可以是抢修团队中的个人，也可以是其他参与抢修决策的人员。",
    "抢修资源": "抢修过程中使用的工具、材料、车辆、仪器仪表或安全用具。",
    "处置方法": "针对故障采取的具体处理步骤、维修手段或操作流程。",
...
relationship_definitions = {
    "故障现象": "描述设备出现了某种具体故障。 (源: 电气设备 -> 目标: 故障表现)",
    "原因为": "描述导致故障表现的具体原因。 (源: 故障表现 -> 目标: 故障原因)",
    "分配维修": "描述团队或人员被指派负责维修某设备或处理某故障。 (源: 抢修团队/人员 -> 目标: 故障表现)",
    "需要资源": "描述维修工作或人员需要的物资和工具。 (源: 故障表现 -> 目标:抢修资源)",
    "组员为": "描述团队包含的人员角色。 (源: 抢修团队 -> 目标: 抢修人员)",
    "可解决": "描述某种方法可以解决特定的故障。 (源: 处置方法 -> 目标: 故障表现/故障原因)",
